...
const url = process.env.NODE_ENV === 'development'
    ? process.env.REACT_APP_DEVELOPMENT_BASEURL + "MiscellaneousAttacks/lockoutfeature"
    : process.env.REACT_APP_PRODUCTION_BASEURL + "MiscellaneousAttacks/lockoutfeature";

const LockOutFeature = () => {
