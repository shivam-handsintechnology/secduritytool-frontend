                    ...
                    <tbody>
                      <tr className="tableRow">
                        ...
                        <td className="tableCell">
                          <a
                            href="https://architectparinshah.com/"
                            target="_blank"
                            rel="nofollow noreferrer noopener"
                          >
                            https://architectparinshah.com/
                          </a>
                        </td>
                      </tr>
                      <tr className="tableRow">
                      ...
                      <tr className="tableRow">
                        ...
                        <td className="tableCell">14 Jun 2023 05:57:51 UTC</td>
                      </tr>
                      <tr className="tableRow">
        ...
        <>
          {Headers.map((item, index) => {
           console.log(item.msg.Missing_field ,mandatory[item.msg.Missing_field])
            return item.msg.Missing_field? <>  <tr className="tableRow">
