          ...
          <div className="row">
            ...
            <div className="col-sm-6 col-lg-3">
              <div className="small-box bg-info">
                ...
                {sqlData === 0 ? <a className="small-box-footer" >No Logs </a> : <Link to="/logs/SQLI" className="small-box-footer">View Logs <i className="fas fa-arrow-circle-right" /></Link>}
              </div>
            </div>
            <div className="col-sm-6 col-lg-3">
              <div className="small-box bg-danger">
                ...
                {BotData === 0 ? <a className="small-box-footer" >No Logs </a> : <Link to="/logs/isBot" className="small-box-footer">View Logs <i className="fas fa-arrow-circle-right" /></Link>
                }
              </div>
            </div>
            <div className="col-sm-6 col-lg-3">
              <div className="small-box bg-success">
                ...
                {ProxyData === 0 ? <a className="small-box-footer" >No Logs </a> : <Link to='/logs/VPN' className="small-box-footer">View Logs <i className="fas fa-arrow-circle-right" /></Link>}
              </div>
            </div>
            <div className="col-sm-6 col-lg-3">
              <div className="small-box bg-warning">
                ...
                {SpamData === 0 ? <a className="small-box-footer" >No Logs </a> : <Link to="/logs/Spam" className="small-box-footer">View Logs <i className="fas fa-arrow-circle-right" /></Link>
                }
              </div>
            </div>
            {/* 4 columns end */}
